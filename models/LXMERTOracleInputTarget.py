...
class LXMERTOracleInputTarget(nn.Module):
    ...
    def forward(self, questions, obj_categories, spatials, crop_features, visual_features, lengths,
        ...
        # Added three new inputs: input_ids, input_mask and segment_ids.
        # These where generated by the LXRTEncoder, but now moved to the
        # LXMERTOracleDataset class for multi GPU capabilities
